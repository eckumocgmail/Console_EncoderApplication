...
public class EncoderApplicationProgram
{
    public static void Start(params string[] args)
    {
        Clear();
        switch (ProgramDialog.SingleSelect("Выберите действие", new string[]{
            "Закодировать файл", "Разкодировать файл", "Протестировать программу", "выход" }, ref args))
        {           
            case "Закодировать файл":
                //RunHost(ref args); break;
            case "Разкодировать файл":
    ...
    [Label("Закодировать бинарные данные файл")]
    public static void Encode(byte[] data)
    {

    }

    [Label("Раскодировать бинарные данные файл")]
    public static void Decode(byte[] data)
    {

    }

    [Label("Закодировать текстовый файл")]
    public static void EncodeFile( [InputFile()] string filename )
    {

    }

    [Label("Раскодировать закодированный файл")]
    ...
    {
        var bit = new Console_Encoder.BitConverter();
